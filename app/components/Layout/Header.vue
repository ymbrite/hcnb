      ...
      <div class="flex items-center justify-between h-20">
        ...
        <div class="flex items-center">
          <NuxtLink to="/" class="flex items-center space-x-3 group">
            ...
            <div class="hidden sm:block">
              <h1 class="text-xl font-bold gradient-text">Markdown 部落格</h1>
              <p class="text-xs text-gray-500 dark:text-gray-400">現代化部落格平台</p>
            </div>
          </NuxtLink>
        </div>
        ...
        <nav class="hidden md:flex items-center space-x-2">
          ...
          <div class="relative group">
            ...
            <div class="absolute top-full left-0 mt-3 w-56 glass rounded-2xl shadow-soft opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 border border-gray-200/50 dark:border-gray-700/50">
              <div class="py-3">
                <NuxtLink 
                  to="/blog/category/技術"
                  class="flex items-center px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100/50 dark:hover:bg-gray-700/50 transition-colors rounded-lg mx-2"
                >
        ...
        <div class="flex items-center space-x-3">
          ...
          <button
            ...
            class="md:hidden p-2 rounded-xl text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200"
            aria-label="開啟選單"
          >
